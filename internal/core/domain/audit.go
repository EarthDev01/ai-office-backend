...
const (
	...
	// w-17: secret_key / โควตา ต่อ service
	AuditServiceSecretIssue   = "service.secret_issue"
	AuditServiceSecretRotate  = "service.secret_rotate"
	AuditServiceSecretCommit  = "service.secret_commit"
	AuditServiceSecretRevoke  = "service.secret_revoke"
	AuditServiceQuotaIncrease = "service.quota_increase"
